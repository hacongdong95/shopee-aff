        ...
        <div style={{ borderTop:'1px solid #f0f0f0', paddingTop:20 }}>
          ...
          {submitted ? (
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              ...
              <div>
                <label style={{ fontSize:12, fontWeight:700, color:'#555', display:'block', marginBottom:6 }}>Đáđánh giáá sao *</label>
...
export default function ProductDetail({ product, related, settings={}, categories=[] }: { product:Product; related:Product[]; settings?:Settings; categories?:any[] }) {
  ...
  const returnText    = settings.return_text     || '?? Đổi trả miễn phí trong 15 ngày'
