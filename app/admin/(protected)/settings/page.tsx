...
const TAB_FIELDS: Record<string, { key: string; label: string; type: string; placeholder: string; hint?: string }[]> = {
  ...
  seo: [
    ...
    { key: 'og_title',        label: 'TiÃªu Ä‘á» khi chia sáº» link (OG Title)', type: 'text', placeholder: 'Shopee Deals â€“ Mua hÃ ng giÃ¡ tá»‘t', hint: 'Hiá»‡n khi chia sáº» lÃªn Zalo, Facebook, Messenger...' },
    { key: 'og_description',  label: 'MÃ´ táº£ khi chia sáº» link (OG Description)', type: 'textarea', placeholder: 'Sáº£n pháº©m giáº£m giÃ¡ tá»‘t nháº¥t tá»« Shopee, giao hÃ ng nhanh toÃ n quá»‘c.', hint: 'NÃªn tá»« 60â€“120 kÃ½ tá»±' },
